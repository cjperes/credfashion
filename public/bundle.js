...
$displayLineElement.addEventListener('click', function (e) {
  ...
  if (isButton) {
    var isNewQuery = e.target.classList.contains('js-new-query');

    this.innerHTML = isNewQuery ? Template.normalTemplate() : Template.successTemplate({ name: 'Raul', total: 100 });
  }
});

},{"./js/Template":3,"vanilla-masker":1}],3:[function(require,module,exports){
"use strict";

...
var url = 'http://rarochat.ddns.me:8080/etiqueta/clientes/?token=ecc06c8d79d3d67b0df5d27004e57c37&cliente=';
...
var CardFactory = function () {
  ...
  _createClass(CardFactory, null, [{
    key: 'queryPoints',
    value: async function queryPoints(cpf) {
      var response = await axios.get(url + cpf);
...
/* Elements */
var $cpfInputElement = document.querySelector('.js-input-cpf');
var $displayLineElement = document.querySelector('.display-line');
var $errorSpan = document.querySelector('.input-error');

/* Functions */
/* eslint-disable */
var cancelSubmit = function cancelSubmit(event) {
  return event.preventDefault();
};
/* eslint-enable */
var isValidInput = function isValidInput() {
  var cpf = $cpfInputElement.value;
  var cpfRegex = /\d{3}.\d{3}.\d{3}-\d{2}/gi;
  return cpfRegex.test(cpf);
};
var handleErrorStatement = function handleErrorStatement() {
...
$displayLineElement.addEventListener('click', function (event) {
  ...
  if (isButton) {
    var isNewQuery = event.target.classList.contains('js-new-query');
...
CardFactory.queryPoints('').then(function (res) {
  return console.log(res);
});

},{"./CardFactory":29,"./js/Template":31,"vanilla-masker":28}],31:[function(require,module,exports){
"use strict";
